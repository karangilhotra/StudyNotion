...
//   console.log("Modal props:", { user, token, courseEntireData });
...
//     await createRating(
//       {
//         courseId: courseEntireData?._id, // safe optional chaining
        ...
        <div className="p-6">
          ...
          >
            ...
            <div className="mt-6 flex w-11/12 justify-end gap-x-2">
              ...
              {typeof IconBtn === "function" && <IconBtn text="Save" />}
            </div>
          </form>
        </div>
      </div>
